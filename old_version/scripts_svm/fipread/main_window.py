...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self) -> None:
        ...
        self._svm_model_directory = Path(r"E:\codes\pccp\LZfeature\saved_models")
    ...
    def _build_ui(self) -> None:
        ...
        directory_layout.addWidget(QtWidgets.QLabel("Audio Path"), 3, 0)
        directory_layout.addWidget(self.audio_path_edit, 3, 1)
        directory_layout.addWidget(self.audio_path_browse_button, 3, 2)
        directory_layout.addWidget(QtWidgets.QLabel("Audio Downsample"), 4, 0)
        directory_layout.addWidget(self.audio_downsample_spin, 4, 1)
        directory_layout.addWidget(self.play_audio_button, 5, 0)
        directory_layout.addWidget(self.stop_audio_button, 5, 1)
        directory_layout.addWidget(self.replay_audio_button, 5, 2)
        directory_layout.addWidget(self.export_audio_button, 6, 0, 1, 3)
        ...
        self.feature_plot.getViewBox().setLimits(yMin=-0.1, yMax=1.1)
    ...
    def _handle_prediction_finished(self, task_id: int, centers: np.ndarray, predictions: np.ndarray) -> None:
        if task_id != self._prediction_task_id:
            return
        if centers.size == 0:
            self._clear_short_time_feature_plot()
