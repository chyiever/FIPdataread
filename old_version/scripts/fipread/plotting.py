...
def configure_plot_widget(plot_widget: pg.PlotWidget, left_label: str, bottom_label: str) -> None:
    ...
    plot_widget.setLabel("left", left_label, color="k", **{"font-family": "Times New Roman", "font-size": "13pt"})
    plot_widget.setLabel("bottom", bottom_label, color="k", **{"font-family": "Times New Roman", "font-size": "13pt"})
    ...
    plot_item.getAxis("left").setTextPen(pg.mkPen("k"))
    plot_item.getAxis("bottom").setPen(pg.mkPen("k"))
    plot_item.getAxis("bottom").setTextPen(pg.mkPen("k"))
    plot_item.getAxis("top").setPen(pg.mkPen("k"))
    plot_item.getAxis("right").setPen(pg.mkPen("k"))
    plot_item.getAxis("top").setTextPen(pg.mkPen("k"))
    plot_item.getAxis("right").setTextPen(pg.mkPen("k"))
